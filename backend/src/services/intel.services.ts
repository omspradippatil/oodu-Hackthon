...
// PORT HEALTH SERVICE
// ============================================================================
export const portHealthService = {
  async getScore() {
    ...
    else if (score < 50) rating = 'CRITICAL';
...
export const recommendService = {
  async getRecommendation(cargoWeight: number, sourceDockId?: string, destination?: string) {
...
export const reportService = {
  async getFleetReport(params: any) {
  ...
  async getTripReport(params: any) {
  ...
  async getFuelReport(params: any) {
  ...
  async getContainerReport(params: any) {
  ...
  async getDriverPerformanceReport(params: any) {
