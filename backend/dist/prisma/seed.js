...
async function main() {
    ...
    const users = await Promise.all([
        prisma.user.upsert({
            ...
            create: {
                ...
                passwordHash: await bcryptjs_1.default.hash('Admin@123', passwordRounds),
                name: 'Admin User',
                role: 'ADMIN',
                status: 'ACTIVE',
            },
        ...
        prisma.user.upsert({
            ...
            create: {
                ...
                passwordHash: await bcryptjs_1.default.hash('Ops@123', passwordRounds),
        ...
        prisma.user.upsert({
            ...
            create: {
                ...
                passwordHash: await bcryptjs_1.default.hash('Fleet@123', passwordRounds),
                name: 'Fleet Manager',
                role: 'FLEET_MANAGER',
                status: 'ACTIVE',
            },
        ...
        prisma.user.upsert({
            ...
            create: {
                ...
                passwordHash: await bcryptjs_1.default.hash('Maint@123', passwordRounds),
        ...
        prisma.user.upsert({
            ...
            create: {
                ...
                passwordHash: await bcryptjs_1.default.hash('Driver@123', passwordRounds),
                name: 'Rajesh Kumar',
                role: 'DRIVER',
                status: 'ACTIVE',
            },
    ...
    // ─── Vehicles ────────────────────────────────────────────────────────────
    const vehicleData = [
        { registrationNo: 'GJ01AB1001', name: 'Heavy Truck Alpha', model: 'Tata Prima 4928.S', type: 'TRUCK', status: 'AVAILABLE', maxCapacity: 30, odometer: 45000, fuelLevel: 85, healthScore: 92 },
        { registrationNo: 'GJ01AB1002', name: 'Heavy Truck Beta', model: 'Tata Prima 4928.S', type: 'TRUCK', status: 'ON_TRIP', maxCapacity: 30, odometer: 62000, fuelLevel: 60, healthScore: 78 },
        { registrationNo: 'GJ01AB1003', name: 'Medium Truck Gamma', model: 'Ashok Leyland 2518', type: 'TRUCK', status: 'AVAILABLE', maxCapacity: 25, odometer: 38000, fuelLevel: 95, healthScore: 96 },
        { registrationNo: 'GJ01AB1004', name: 'Container Truck Delta', model: 'Volvo FH 480', type: 'TRUCK', status: 'IN_SHOP', maxCapacity: 35, odometer: 120000, fuelLevel: 40, healthScore: 55 },
        { registrationNo: 'GJ01AB1005', name: 'Long Haul Truck Epsilon', model: 'Scania R410', type: 'TRUCK', status: 'AVAILABLE', maxCapacity: 40, odometer: 88000, fuelLevel: 72, healthScore: 83 },
        { registrationNo: 'GJ01AB2001', name: 'Port Trailer Zeta', model: 'Tata LPT 4923', type: 'TRAILER', status: 'AVAILABLE', maxCapacity: 45, odometer: 55000, fuelLevel: 90, healthScore: 89 },
        { registrationNo: 'GJ01AB2002', name: 'Flatbed Trailer Eta', model: 'Tata LPT 4923', type: 'TRAILER', status: 'ON_TRIP', maxCapacity: 45, odometer: 73000, fuelLevel: 55, healthScore: 74 },
        { registrationNo: 'GJ01AB2003', name: 'Container Trailer Theta', model: 'Mahindra Blazo X 28', type: 'TRAILER', status: 'AVAILABLE', maxCapacity: 28, odometer: 29000, fuelLevel: 88, healthScore: 94 },
        { registrationNo: 'GJ01AB3001', name: 'Forklift Iota', model: 'Toyota 8FBM25', type: 'FORKLIFT', status: 'AVAILABLE', maxCapacity: 2.5, odometer: 12000, fuelLevel: 100, healthScore: 97 },
        { registrationNo: 'GJ01AB3002', name: 'Forklift Kappa', model: 'Kion Linde H30', type: 'FORKLIFT', status: 'AVAILABLE', maxCapacity: 3, odometer: 8500, fuelLevel: 95, healthScore: 99 },
        { registrationNo: 'GJ01AB3003', name: 'Heavy Forklift Lambda', model: 'Hyster H7.0FT', type: 'FORKLIFT', status: 'IN_SHOP', maxCapacity: 7, odometer: 25000, fuelLevel: 30, healthScore: 42 },
        { registrationNo: 'GJ01AB4001', name: 'Reach Stacker Mu', model: 'Liebherr LRS 545', type: 'REACH_STACKER', status: 'AVAILABLE', maxCapacity: 45, odometer: 33000, fuelLevel: 78, healthScore: 87 },
        { registrationNo: 'GJ01AB4002', name: 'Reach Stacker Nu', model: 'Kalmar DRG450', type: 'REACH_STACKER', status: 'AVAILABLE', maxCapacity: 45, odometer: 41000, fuelLevel: 65, healthScore: 82 },
        { registrationNo: 'GJ01AB5001', name: 'Crane Truck Xi', model: 'Tata Prima 4923.S CNG', type: 'CRANE_TRUCK', status: 'AVAILABLE', maxCapacity: 20, odometer: 19000, fuelLevel: 92, healthScore: 91 },
        { registrationNo: 'GJ01AB1006', name: 'Truck Omicron', model: 'BharatBenz 4428', type: 'TRUCK', status: 'AVAILABLE', maxCapacity: 32, odometer: 51000, fuelLevel: 80, healthScore: 86 },
        { registrationNo: 'GJ01AB1007', name: 'Truck Pi', model: 'Eicher Pro 6016', type: 'TRUCK', status: 'RETIRED', maxCapacity: 16, odometer: 215000, fuelLevel: 0, healthScore: 15 },
        { registrationNo: 'GJ01AB2004', name: 'Trailer Rho', model: 'Tata Signa 4825.TK', type: 'TRAILER', status: 'AVAILABLE', maxCapacity: 25, odometer: 44000, fuelLevel: 77, healthScore: 85 },
        { registrationNo: 'GJ01AB3004', name: 'Forklift Sigma', model: 'Crown SC 5200', type: 'FORKLIFT', status: 'AVAILABLE', maxCapacity: 2, odometer: 5000, fuelLevel: 100, healthScore: 100 },
        { registrationNo: 'GJ01AB4003', name: 'Reach Stacker Tau', model: 'Manitowoc Grove RT760E', type: 'REACH_STACKER', status: 'AVAILABLE', maxCapacity: 40, odometer: 22000, fuelLevel: 85, healthScore: 93 },
        { registrationNo: 'GJ01AB5002', name: 'Crane Truck Upsilon', model: 'Tata Prima 5530.S', type: 'CRANE_TRUCK', status: 'AVAILABLE', maxCapacity: 22, odometer: 17000, fuelLevel: 90, healthScore: 95 },
    ];
    const vehicles = await Promise.all(vehicleData.map(v => prisma.vehicle.upsert({
    ...
    // ─── Drivers ─────────────────────────────────────────────────────────────
    const driverData = [
        { name: 'Rajesh Kumar', licenseNo: 'GJ01-2019-001234', licenseCategory: 'HMV', licenseExpiry: new Date('2027-06-15'), phone: '9876543210', safetyScore: 96, experienceYears: 8, status: 'AVAILABLE' },
        { name: 'Suresh Patel', licenseNo: 'GJ01-2020-005678', licenseCategory: 'HMV', licenseExpiry: new Date('2028-03-20'), phone: '9876543211', safetyScore: 88, experienceYears: 6, status: 'ON_TRIP' },
        { name: 'Mahesh Singh', licenseNo: 'GJ01-2018-009012', licenseCategory: 'HMV', licenseExpiry: new Date('2026-09-10'), phone: '9876543212', safetyScore: 91, experienceYears: 10, status: 'AVAILABLE' },
        { name: 'Ramesh Yadav', licenseNo: 'GJ01-2021-003456', licenseCategory: 'LMV', licenseExpiry: new Date('2029-01-25'), phone: '9876543213', safetyScore: 82, experienceYears: 4, status: 'AVAILABLE' },
        { name: 'Dinesh Sharma', licenseNo: 'GJ01-2017-007890', licenseCategory: 'HMV', licenseExpiry: new Date('2025-12-31'), phone: '9876543214', safetyScore: 74, experienceYears: 12, status: 'OFF_DUTY' },
        { name: 'Kamlesh Verma', licenseNo: 'GJ01-2022-001122', licenseCategory: 'HMV', licenseExpiry: new Date('2030-08-15'), phone: '9876543215', safetyScore: 95, experienceYears: 3, status: 'AVAILABLE' },
        { name: 'Naresh Joshi', licenseNo: 'GJ01-2019-003344', licenseCategory: 'HMV', licenseExpiry: new Date('2027-11-05'), phone: '9876543216', safetyScore: 78, experienceYears: 7, status: 'AVAILABLE' },
        { name: 'Lokesh Tiwari', licenseNo: 'GJ01-2020-005566', licenseCategory: 'LMV', licenseExpiry: new Date('2028-04-18'), phone: '9876543217', safetyScore: 85, experienceYears: 5, status: 'SUSPENDED' },
        { name: 'Ganesh Mishra', licenseNo: 'GJ01-2018-007788', licenseCategory: 'HMV', licenseExpiry: new Date('2026-07-22'), phone: '9876543218', safetyScore: 90, experienceYears: 9, status: 'AVAILABLE' },
        { name: 'Ramakant Dubey', licenseNo: 'GJ01-2021-009900', licenseCategory: 'HMV', licenseExpiry: new Date('2029-02-14'), phone: '9876543219', safetyScore: 87, experienceYears: 4, status: 'ON_TRIP' },
        { name: 'Vikas Chauhan', licenseNo: 'GJ01-2016-001234', licenseCategory: 'HMV', licenseExpiry: new Date('2024-10-10'), phone: '9876543220', safetyScore: 65, experienceYears: 14, status: 'OFF_DUTY' },
        { name: 'Sanjay Rawat', licenseNo: 'GJ01-2022-005678', licenseCategory: 'HMV', licenseExpiry: new Date('2030-06-30'), phone: '9876543221', safetyScore: 98, experienceYears: 2, status: 'AVAILABLE' },
        { name: 'Anil Pandey', licenseNo: 'GJ01-2019-009012', licenseCategory: 'HMV', licenseExpiry: new Date('2027-09-08'), phone: '9876543222', safetyScore: 83, experienceYears: 7, status: 'AVAILABLE' },
        { name: 'Mohan Gupta', licenseNo: 'GJ01-2020-003456', licenseCategory: 'LMV', licenseExpiry: new Date('2028-12-15'), phone: '9876543223', safetyScore: 79, experienceYears: 5, status: 'AVAILABLE' },
        { name: 'Deepak Thakur', licenseNo: 'GJ01-2021-007890', licenseCategory: 'HMV', licenseExpiry: new Date('2029-03-22'), phone: '9876543224', safetyScore: 94, experienceYears: 3, status: 'AVAILABLE' },
    ];
    const drivers = await Promise.all(driverData.map(d => prisma.driver.upsert({
    ...
    // ─── Containers ──────────────────────────────────────────────────────────
    const containerData = [
        { containerCode: 'VADHV001', weight: 18500, priority: 'HIGH', status: 'WAITING', sourceDockId: docks[1].id, destWarehouseId: warehouses[0].id, shipId: ships[0].id },
        { containerCode: 'VADHV002', weight: 22000, priority: 'CRITICAL', status: 'LOADING', sourceDockId: docks[5].id, destWarehouseId: warehouses[1].id, shipId: ships[2].id },
        { containerCode: 'VADHV003', weight: 15000, priority: 'MEDIUM', status: 'IN_TRANSIT', sourceDockId: docks[0].id, destWarehouseId: warehouses[0].id },
        { containerCode: 'VADHV004', weight: 28000, priority: 'HIGH', status: 'WAITING', sourceDockId: docks[1].id, destWarehouseId: warehouses[2].id, shipId: ships[0].id },
        { containerCode: 'VADHV005', weight: 12500, priority: 'LOW', status: 'DELIVERED', destWarehouseId: warehouses[1].id },
        { containerCode: 'VADHV006', weight: 19800, priority: 'MEDIUM', status: 'ALLOCATED', sourceDockId: docks[5].id, destWarehouseId: warehouses[0].id, shipId: ships[2].id },
        { containerCode: 'VADHV007', weight: 25000, priority: 'CRITICAL', status: 'WAITING', sourceDockId: docks[5].id, destWarehouseId: warehouses[2].id, shipId: ships[2].id },
        { containerCode: 'VADHV008', weight: 17500, priority: 'MEDIUM', status: 'WAITING', sourceDockId: docks[1].id, destWarehouseId: warehouses[1].id, shipId: ships[0].id },
        { containerCode: 'VADHV009', weight: 30000, priority: 'HIGH', status: 'LOADING', sourceDockId: docks[5].id, destWarehouseId: warehouses[0].id, shipId: ships[2].id },
        { containerCode: 'VADHV010', weight: 11000, priority: 'LOW', status: 'CANCELLED' },
    ];
    const containers = await Promise.all(containerData.map(c => prisma.container.upsert({
    ...
    const trips = await Promise.all(tripData.map(t => prisma.trip.upsert({
